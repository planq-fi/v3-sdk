import { BigintIsh, Token } from '@planq-fi/sdk-core'
import { Interface } from '@ethersproject/abi'
import ISelfPermit from '@planq-fi/periphery/artifacts/contracts/interfaces/ISelfPermit.sol/ISelfPermit.json'
