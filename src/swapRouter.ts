...
import { BigintIsh, Currency, CurrencyAmount, Percent, TradeType, validateAndParseAddress } from '@planq-fi/sdk-core'
...
import ISwapRouter from '@planq-fi/periphery/artifacts/contracts/SwapRouter.sol/SwapRouter.json'
...
/**
 * Represents the PlanqFi V3 SwapRouter, and has static methods for helping execute trades.
 */
